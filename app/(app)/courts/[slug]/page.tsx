...
import { GET_COURT_BY_SLUG } from "@/graphql/queries/pages/courtQuery";
...
import { GET_COURT_SLUGS } from "@/graphql/queries/pages/courtSlugQuery";
...
export default async function CourtPageTemplate({
