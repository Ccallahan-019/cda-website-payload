                    ...
                    <table className="min-w-full">
                        <tbody className="divide-y divide-gray-200">
                            ...
                            <tr key={court.id || index}>
                                <td className="pl-8 py-4 text-sm font-bold text-gray-900 whitespace-nowrap">
                                ...
                                <td className="pr-8 py-4 text-sm font-medium text-right text-gray-900 whitespace-nowrap">
                                    <div className="space-y-1">
