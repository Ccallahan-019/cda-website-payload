...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "page_blocks_form_block" (
  ...
  CREATE TABLE IF NOT EXISTS "_page_v_blocks_form_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  ...
  DO $$ BEGIN
   ALTER TABLE "page_blocks_form_block" ADD CONSTRAINT "page_blocks_form_block_form_id_forms_id_fk" FOREIGN KEY ("form_id") REFERENCES "public"."forms"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "page_blocks_form_block" ADD CONSTRAINT "page_blocks_form_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."page"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_page_v_blocks_form_block" ADD CONSTRAINT "_page_v_blocks_form_block_form_id_forms_id_fk" FOREIGN KEY ("form_id") REFERENCES "public"."forms"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_page_v_blocks_form_block" ADD CONSTRAINT "_page_v_blocks_form_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_page_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "page_blocks_form_block_order_idx" ON "page_blocks_form_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "page_blocks_form_block_parent_id_idx" ON "page_blocks_form_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "page_blocks_form_block_path_idx" ON "page_blocks_form_block" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "page_blocks_form_block_form_idx" ON "page_blocks_form_block" USING btree ("form_id");
  CREATE INDEX IF NOT EXISTS "_page_v_blocks_form_block_order_idx" ON "_page_v_blocks_form_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_page_v_blocks_form_block_parent_id_idx" ON "_page_v_blocks_form_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_page_v_blocks_form_block_path_idx" ON "_page_v_blocks_form_block" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_page_v_blocks_form_block_form_idx" ON "_page_v_blocks_form_block" USING btree ("form_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   ALTER TABLE "page_blocks_form_block" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "_page_v_blocks_form_block" DISABLE ROW LEVEL SECURITY;
  ...
  DROP TABLE "page_blocks_form_block" CASCADE;
  DROP TABLE "_page_v_blocks_form_block" CASCADE;
